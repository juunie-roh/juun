...
export default function ThemeSwitch() {
  ...
  return (
    <Button
      variant="outline"
      size="icon"
      className="border-input relative h-8 w-16 overflow-hidden rounded-full border p-0"
      onClick={toggleTheme}
    >
      {/* Background track */}
      ...
      {/* Moving thumb */}
      <div
        className="bg-background absolute size-6 rounded-full shadow-sm transition-all duration-300 ease-in-out"
        style={{
