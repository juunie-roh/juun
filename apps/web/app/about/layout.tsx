...
import { stabilGroteskTrial, victorSerifTrial } from "@/assets/fonts";
...
export default function AboutLayout({
  ...
  return (
    <Fragment>
      <header className={`${stabilGroteskTrial.className} select-none`}>
        ...
        <div className="bg-background relative w-full px-4">
          <div className="relative mx-auto size-full max-w-7xl overflow-hidden">
            ...
            <h2
              className={`${victorSerifTrial.className} text-muted-foreground max-w-1/2 mt-4 min-h-[10vw] text-sm md:text-xl lg:text-3xl`}
            >
