  ...
  return handle ? (
    <DialogHeader {...props}>
      <Button
        ...
        variant="link"
        ref={setNodeRef}
        className="ring-offset-background focus:ring-ring data-[state=open]:bg-accent data-[state=open]:text-muted-foreground rounded-xs focus:outline-hidden absolute right-10 top-1.5 cursor-move opacity-70 transition-opacity hover:opacity-100 focus:ring-2 focus:ring-offset-2 disabled:pointer-events-none [&_svg:not([class*='size-'])]:size-4 [&_svg]:pointer-events-none [&_svg]:shrink-0"
        {...attributes}
        {...listeners}
      >
        <Grip />
