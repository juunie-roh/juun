...
import { ConfirmWheel, FiveWheel, FourWheel, Wheel } from '.';
...
describe('Wheel Component', () => {
  ...
  describe('FourWheel', () => {
    ...
    it('should render with confirm type (4 sectors)', () => {
      render(<FourWheel />);
      const paths = document.querySelectorAll('path');
      expect(paths.length).toBe(8);
    });
  ...
  describe('FiveWheel', () => {
    ...
    it('should render with confirm type (5 sectors)', () => {
      render(<FiveWheel />);
      const paths = document.querySelectorAll('path');
      expect(paths.length).toBe(10);
    });
